...
if ( isset( $_GET[ "country" ] ) ) {
	$country_text = $_GET[ "country" ];
}
$arr = $fruit->ShowFruitCountries();
$arr2 = $fruit->ShowFruitCountry($country_text);
?>

<link href="/css/main/main.css" rel="stylesheet" type="text/css"/>
<link href="/css/main/country.css" rel="stylesheet" type="text/css"/>
<div class="mid">
                ...
                <div class="col-md-3">
                    <div class="list-group">
                       ...
                       <?php
						foreach($arr as $row)
						{
							if($country_text==$row['country'])echo"<a href='/country/?country=$row[country]' class='list-group-item list-group-item-action' id='country_item_bold' ><i class='fas fa-angle-right'></i>Trái cây $row[country] </a>";
							else echo"<a href='/country/?country=$row[country]' class='list-group-item list-group-item-action'><i class='fas fa-angle-right'></i>Trái cây $row[country] </a>";
						}
						?>
